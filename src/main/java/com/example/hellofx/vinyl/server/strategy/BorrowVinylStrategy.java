...
public class BorrowVinylStrategy extends AbstractVinylStrategy {
    @Override
    ...
    public Map<String, Object> handle(RequestContext context, Map<String, Object> request) {
        ...
        context.getLibrary().borrow(vinyl, user);
        return ServerMessages.vinylResponse(request, "Vinyl borrowed.", vinyl);
    }
}
